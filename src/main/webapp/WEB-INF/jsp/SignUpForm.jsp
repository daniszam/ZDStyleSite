...
<form id="singUp" method="post">
    ...
    <div id="wrapper">
        ...
        <input id="password" name="password" placeholder="Password" type="password" minlength="6">
        <input id="repassword" name="repassword" placeholder="Repeat password" type="password" minlength="6">
        <input id="birthday" name="birthday" placeholder="Date" class="textbox-n" type="text" onfocus="(this.type='date')"  id="date">
        ...
        <input name="sex" type="radio" value="Male" id="Male">
        <label for="Male" style="text-align: left">Male</label>
        <input name="sex" type="radio" value="Female" id="Female">
    ...
    <button id="submit" type="submit" value="Join">
    <span>
      Sign up
    </span>
    </button>
